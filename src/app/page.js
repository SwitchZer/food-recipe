...
export default function Home() {
  const popularRecipeData = [
    {
      src: "/963db6b71f49aff171a04b7628a3233ac72fbaeb5bdaaa85179b647a93897088.png",
      text: "Chiken Kare",
      heading: "Chiken <br /> Kare",
    },
    {
      src: "/963db6b71f49aff171a04b7628a3233ac72fbaeb5bdaaa85179b647a93897088.png",
      text: "Bomb Chicken",
      heading: "Bomb <br /> Chicken",
    },
    {
      src: "/963db6b71f49aff171a04b7628a3233ac72fbaeb5bdaaa85179b647a93897088.png",
      text: "Banana Smoothie Pop",
      heading: "Banana <br /> Smoothie Pop",
    },
    {
      src: "/963db6b71f49aff171a04b7628a3233ac72fbaeb5bdaaa85179b647a93897088.png",
      text: "Coffee Lava Cake",
      heading: "Coffe Lava <br /> Cake",
    },
    {
      src: "/963db6b71f49aff171a04b7628a3233ac72fbaeb5bdaaa85179b647a93897088.png",
      text: "Sugar Salmon",
      heading: "Sugar <br /> Salmon",
    },
    {
      src: "/963db6b71f49aff171a04b7628a3233ac72fbaeb5bdaaa85179b647a93897088.png",
      text: "Indian Salad",
      heading: "Indian <br /> Salad",
    },
  ];
  return (
    <div className="flex flex-col bg-white">
      ...
      <div className="flex flex-col mb-9 w-full px-20 max-w-[1675px] max-md:max-w-full">
        ...
        <section className="flex flex-col self-center px-px mt-52 w-full max-w-[1651px] max-md:mt-10 max-md:max-w-full">
          ...
          <div className="px-5 mt-28 max-md:mt-10 max-md:max-w-full">
            <div className="flex gap-5 max-md:flex-col max-md:gap-0">
              {popularRecipeData.slice(0, 3).map((item, idx) => (
                <ImageCard
                  key={idx}
                  src={item.src}
                  text={item.text}
          ...
          <div className="px-5 mt-20 max-md:mt-10 max-md:max-w-full">
            <div className="flex gap-5 max-md:flex-col max-md:gap-0">
              {popularRecipeData.slice(3).map((item, idx) => (
                <ImageCard
                  key={idx}
                  src={item.src}
                  text={item.text}
